...
module.exports={
  server:app,
  start: port =>{ 
    if (!port){throw new Error('Something is missing :/');}
    app.listen(port,()=> console.log(`"All at once everything looks different, now that I see you"-Tangled on port ${port}'`))
  },
};
